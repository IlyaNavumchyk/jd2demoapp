...
public class JdbcTemplateRoleRepository implements RoleRepositoryInterface {
    ...
    public Role findById(Integer id) {
        try {
            ...
            throw new NoSuchEntityException("Entity Role with id " + id + " does not exist", 404, UUIDGenerator.generateUUID());
        }
    }
    ...
    public List<Role> findAll() {
        return findAll(CRUDRepository.DEFAULT_FIND_ALL_LIMIT, CRUDRepository.DEFAULT_FIND_ALL_OFFSET);
    }
